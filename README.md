...
8. Once Pull Request is in ready to review state, a pre-release is generated and `accounts-api-client-sdk` repository is tiggered to generate a new SDK package. Package version follows development branch version number + build run number, eg. **`1.0.11-dev.5`**.
...
The OpenAPI JSON file is available at [\*\*https://chillibean.github.io/accounts-api](https://chillibean.github.io/%7B%7BapiPackageName%7D)}/fullSchema.json\*\*.
